...
public class TripsReservationsViewModel {
	...
	private void fetchReservations(String username) {
		...
		try {
			List<Reservation> userReservations = backendMapper.mapListFromBackend(Reservation.class, url, HTTP_GET);
	...
	public void createReservationForTrip(Trip trip, int travelersQty, int stopOriginId, String username, boolean isWaitList) {
